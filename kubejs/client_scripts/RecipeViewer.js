...
RecipeViewerEvents.removeEntriesCompletely('item', allthemods => {
    ...
    allthemods.remove('industrialforegoing:mycelial_frosty')
    allthemods.remove('industrialforegoing:mycelial_explosive')
    allthemods.remove('industrialforegoing:mycelial_ender')
    allthemods.remove('industrialforegoing:mycelial_disenchantment')
    allthemods.remove('industrialforegoing:mycelial_potion')
    allthemods.remove('industrialforegoing:mycelial_culinary')
    allthemods.remove('industrialforegoing:mycelial_slimey')
    allthemods.remove('industrialforegoing:mycelial_furnace')
    allthemods.remove('industrialforegoing:mycelial_reactor')
    allthemods.remove('industrialforegoing:mycelial_rocket')
    allthemods.remove('industrialforegoing:mycelial_crimed')    
    allthemods.remove('industrialforegoing:mycelial_meatallurgic')   
    allthemods.remove('industrialforegoing:mycelial_death')
    allthemods.remove('industrialforegoing:mycelial_netherstar')
    allthemods.remove('industrialforegoing:mycelial_pink')
    allthemods.remove('industrialforegoing:mycelial_magma')
    allthemods.remove('industrialforegoing:mycelial_halitosis')
