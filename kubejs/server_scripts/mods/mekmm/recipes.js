...
ServerEvents.recipes(allthemods => {
    ...
    allthemods.remove({id: 'mekmm:large_heat_generator'})
    allthemods.remove({id: 'mekmm:large_gas_burning_generator'})
    allthemods.remove({id: 'mekmm:solar_heat_generator'})
    allthemods.remove({id: 'mekmm:large_wind_generator'})
